  ...
  return (
    <Row gutter={[16, 12]} style={{backgroundColor:"#F0F2F5", padding: "24px 12px"}}>
      <Col className="gutter-row" span={6} style={style}>
        <div style={{color:"#8C8C8C", fontSize:"14px", marginBottom:"20px"}}>Tổng số bài đăng chờ duyệt</div>
      ...
      <Col className="gutter-row" span={6} style={style}>
        <div style={{color:"#8C8C8C", fontSize:"14px", marginBottom:"20px"}}>Tổng số tố cáo chờ duyệt</div>
        <div style={{fontSize:"30px", fontWeight:"600"}}>
        {
      ...
      <Col className="gutter-row" span={6} style={style}>
        <div style={{color:"#8C8C8C", fontSize:"14px", marginBottom:"20px"}}>Tổng số người dùng đã đang sử dụng</div>
        <div style={{fontSize:"30px", fontWeight:"600"}}>{dashboard.countUserPerStatus.num_of_unverified + dashboard.countUserPerStatus.num_of_verified + dashboard.countUserPerStatus.num_of_banned}</div>
        <Divider/>
        <div>Tổng số người dùng đã xác thực: {dashboard.countUserPerStatus.num_of_verified}</div>
      </Col>

      <Col className="gutter-row" span={6} style={style}>
        <div style={{color:"#8C8C8C", fontSize:"14px", marginBottom:"20px"}}>Tổng số bài blog đã đăng</div>
        <div style={{fontSize:"30px", fontWeight:"600"}}>{dashboard.countBlog}</div>
      </Col>
        ...
        <div style={style}>
          ...
          <div style={{fontSize:"16px", fontWeight:"600"}}>Số lượng bài đăng bán/cho thuê trong năm 2023</div>
            ...
            <div style={{display:"flex", alignItems: "flex-start", gap:"24px"}}>
              <div style={{width:"75%"}}>
                <DoubleLineChart pieChartData={dashboard.countPostByTypeInMonthOfYear}/>
              </div>
    ...
    <Col className="gutter-row" span={8}>
            ...
            <div style={{fontSize:"16px", fontWeight:"600"}}>Tỉ lệ các loại bất động sản trong các bài đăng</div>
              <Divider/>
              <AppCircleChart pieChartData={dashboard.countPostByTypeInMonthOfYear}/>
              </div>
          </Col>

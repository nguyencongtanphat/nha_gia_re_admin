...
export async function loader() {
  const users = await ApiService.get('account-verification-requests?is_verified[eq]=false&page=all&reviewed_at[is]=null');
  ...
  return (
    <div>
      <Card>
        ...
        <PostTable columns={columns} data={users} abc="DS Người dùng chờ xác minh" />,
      </Card>
    </div>
  );
}
